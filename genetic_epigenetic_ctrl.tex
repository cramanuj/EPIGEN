...
\fancyhf{}
\lhead{\fancyplain{}{}}
\rhead{\fancyplain{}{Technical Report}}
...
\begin{center}
\begin{figure}[!ht]
%\resizebox{.8\textwidth}{!}{\includegraphics{JT_JAG_TBT.pdf}}
...
\begin{figure}[!ht]
\hfill
\subfigure[Correlation heatmap ]{\includegraphics[width=8.5cm]{brain_disease_cor_plots.pdf}}
\hfill
\subfigure[Network map]{\includegraphics[width=8cm]{brain_disease_network.pdf}}
\hfill
...
\begin{center}
\begin{figure}[!h]
\includegraphics[width=\textwidth]{separateTBT_plots.pdf}
...
\begin{center}
\begin{figure}[H]
\includegraphics[width=0.75\textwidth]{TBT_JT_KEGG.pdf}
...
%\subsubsection{Region-by-Region analysis: eQTL analysis using methylation as a baseline covariate}
%
%In a region-by-region analysis, we apply the following regression model to identify mRNA-CpG-SNP triplets by using methylation as a baseline covariate--
%
%\begin{equation*}
...
%%\end{table}
%
%\subsubsection{Joint analysis using JAGUAR to perform separate eQTL and mQTL analyses (an alternative to TBT analysis)}
%
